...
RG = ZZZZZ #"Keski-Suomi"
trade_off = XXXXX #"INC_PEAT"
constraint = YYYYY #"NPV"
...
class optimization:
    def __init__(self):
        ...
        #NO ditching
        self.data_no = pd.read_csv("/scratch/project_2000611/KYLE/SpaFHy_manuscript/simulated_data/rslt_GWT_w_SPAFHY_PEAT_"+RG+"_no.csv")
        #Yes to ditching
        self.data_yes = pd.read_csv("/scratch/project_2000611/KYLE/SpaFHy_manuscript/simulated_data/rslt_GWT_w_SPAFHY_PEAT_"+RG+"_yes.csv")
